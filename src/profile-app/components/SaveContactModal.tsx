...
export const SaveContactModal = ({ isOpen, ...props }: SaveContactModalProps) => (
  <AnimatePresence>{isOpen ? <SaveContactModalPanel {...props} /> : null}</AnimatePresence>
)

function SaveContactModalPanel({ onClose, onSuccess, profileId }: Omit<SaveContactModalProps, 'isOpen'>) {
